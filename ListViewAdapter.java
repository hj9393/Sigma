...
public class ListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ImageView iconImageView = (ImageView) convertView.findViewById(R.id.image_video) ;
        ...
        TextView VideoNameTextView = (TextView)convertView.findViewById(R.id.txt_videoname);
        ...
        VideoNameTextView.setText(listViewItem.getVideoname());
        return convertView;
    }
    ...
    public Drawable getIcon(int position) {
        return listViewItemList.get(position).getIcon();
    }
    ...
    public String getvideoname(int position) {
        return listViewItemList.get(position).getVideoname() ;
    }
    // 아이템 데이터 추가를 위한 함수. 개발자가 원하는대로 작성 가능.
    public void addItem(/*Drawable icon,*/ String address, String date,String videoname) {
